...
instructor: ["Mohammed Tanash", "Emelie Fuchs", "Caughlin Bohn"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Natasha Pavlovikj", "Niruktha Roy Gotoor", "Tom Harvill", "Chia Sin Liew", "Scout Calvert", "Leslie Delserone"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<center><form><button name="button" style="background-color: D71920; padding: 15px 32px" formaction="https://marketplace.unl.edu/hcc/hcc-software-carpentry-workshop-january-2023.html?button=">Registration now open!</button></form></center>
